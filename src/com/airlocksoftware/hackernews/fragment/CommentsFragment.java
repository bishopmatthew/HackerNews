...
public class CommentsFragment extends Fragment implements ActionBarClient, LoaderCallbacks<CommentsResponse> {
  ...
  // Constants
  public static final String NAME = CommentsFragment.class.getSimpleName();
  public static final String STORY = NAME + ".story";
  public static final String LIST_STATE = NAME + ".listState";
  ...
  public void onActivityCreated(Bundle savedInstanceState) {
    ...
    if (mCallbacks == null || mTabletLayout == null) {
      retrieveCallbacks(activity);
    }
  ...
  private void setupHeader() {
    mHeaderView = LayoutInflater.from(getActivity()).inflate(R.layout.vw_comment_header, null);
    mHeaderView.setVisibility(View.GONE);
  }

  private void findLoadingAndErrorViews(View container) {
    mLoading = container.findViewById(R.id.cnt_loading);
    mEmpty = container.findViewById(R.id.cnt_empty);
  ...
  public void onSaveInstanceState(Bundle outState) {
    ...
    if (mAdapter != null) {
      outState.putSerializable(COMMENTS, (Serializable) mAdapter.getArray());
    }
  ...
  public void setStory(Story story) {
    ...
    refreshActionBarButtonVisibility();
    if (mAdapter != null) {
      mAdapter.setParentStory(mStory);
    }
  }
  ...
  private void bindStoryHeader() {
    ...
    if (hasSelfText) {
      mHeaderSelfText.setText(Html.fromHtml(mStory.selfText));
    }
   ...
   * interface, and store it in mCallbacks.
   */
  ...
  private void refreshContentVisibility() {
    ...
    if (mAdapter == null || mList == null || mError == null || mLoading == null || mEmpty == null) {
      return;
    }
  ...
  private void refreshActionBarButtonVisibility() {
    ...
    if (mBrowserButton != null) {
      mBrowserButton.setVisibility(ViewUtils.boolToVis(showBrowser));
    }
  }
